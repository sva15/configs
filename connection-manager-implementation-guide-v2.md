...
aws lambda create-function \
  ...
  --timeout 30 \
  --memory-size 256 \
  --layers arn:aws:lambda:ap-south-1:<ACCOUNT_ID>:layer:<YOUR_PSYCOPG2_LAYER_NAME>:<VERSION> \
  --environment Variables="{CONNECTION_MANAGER_URL=http://10.0.1.55/db-proxy}" \
  --region ap-south-1
```
